...
def get_todays_matches():
    """Récupère les 10 meilleurs matchs du jour depuis l'API GROQ"""
    try:
        response = requests.post(
            "https://api.sanity.io/v2021-10-21/data/query/production",  # endpoint GROQ par défaut
...
async def send_matches():
    ...
    for match in matches:
        ...
        # Message complet analyse + pronostic
        message_text = (
